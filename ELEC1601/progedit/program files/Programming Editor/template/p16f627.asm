...
; ************************************
	...
	list      p=16F627             ; define PICmicro type
        #include <p16F627.inc>         ; variable definitions
...
;This default line uses external ceramic resonator
	__CONFIG   _CP_OFF & _WDT_OFF & _XT_OSC & _PWRTE_ON & _BODEN_ON & _LVP_OFF& _MCLRE_ON

;uncomment this line instead for internal resonator (provides two extra input pins on PORTA)
;	__CONFIG   _CP_OFF & _WDT_OFF & _INTRC_OSC_NOCLKOUT & _PWRTE_ON & _BODEN_ON & _LVP_OFF& _MCLRE_ON
...
init:					; (initialisation goes here)
	...
	;Note that if using code originally for 16F84A these two extra lines are required.
	movlw	b'00000111'		; set all of PORTA pins to be digital
	movwf	CMCON			; inputs rather than default comparators
